					...
					<?php else : ?>
						...
						?>
							<header class="entry-header">
								<h1 class="entry-title"><?php _e( 'No posts to display', 'text-domain' ); ?></h1>
							</header>

							<div class="entry-content">
								<p><?php printf( __( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'text-domain' ), admin_url( 'post-new.php' ) ); ?></p>
							</div><!-- .entry-content -->
